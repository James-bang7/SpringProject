...
<script type="text/javascript">
	...
	function insertPop() {
		...
		$("#popupForm").attr("action","selectDepartment.do")
		$("#popupForm").attr("target","pop")
		$("#popupForm").submit();
	}
	
	function updatePop(deptid) {
		$("#deptid").val(deptid);
		window.open("", "pop", "width=480, height=280");
		$("#popupForm").attr("action","selectDepartment.do")
		$("#popupForm").attr("target","pop")
	...
	function searchlist() {
		$("#searchForm").attr("action","listDepartment.do")
		$("#searchForm").submit();
	}
...
<body>
	...
	<div>
		<h4 align="center">학과테이블 [Spring]</h4>
	</div>
	<div>
		<table border="1">		
			<colgroup>
			...
			<tbody>
				...
				<c:forEach items="${departmentList}" var="row">
					<tr>
						...
						<td align="center">
							<input type="button" value="[ 수정/삭제 ]" onclick="updatePop('${row.deptid}')"/>
						</td>
					</tr>
				</c:forEach>
					<tr>
						...
						<td align="center">
							<input type="button" value="[ 등록 ]" onclick="insertPop()"/>
						</td>
					</tr>
			</tbody>
		</table>	
		...
		<form id="searchForm" name="searchForm" method="post">
			<table border="1" cellpadding="1" cellspacing="1">
				<tr>
					...
					<td><input type="button" onclick="searchlist()" value="검색"/></td>
				</tr>
			</table>
